    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          <img src={logoImg} alt="BarberTop" className="w-9 h-9 rounded-lg object-cover" />
          <span
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-blue-900">42 {t("land.acceptingNow")}</p>
          </motion.div>
        </motion.div>
      </div>
...
const SearchBar = () => {
  return (
    <motion.div
      ...
      className="hidden md:block absolute -bottom-12 left-1/2 -translate-x-1/2 w-[92%] max-w-5xl z-20"
    >
      <div
...
const TopBarbers = () => {
  ...
  // Ma'lumotlarni tarjima kalitlariga moslab optimallashtiramiz
  const barbers = [
    {
      name: "Davron Karimov",
      img: styleFade,
            ...
            >
              <div className="relative h-72 overflow-hidden">
                ...
                {b.pro && (
                  ...
                  >
                    <Crown className="w-3 h-3" /> {t("common.pro")}
                  </div>
                )}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between text-xs text-blue-600 mb-3">
                  {/* Dinamik tajriba matni */}
                  <span>
                    {b.expVal} {t("common.expYears")}
                  </span>
    ...
    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-blue-100 to-white">
      ...
      <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <motion.div {...fadeUp}>
          ...
          >
            <Brain className="w-3.5 h-3.5" /> {t("land.aiTag")}
          </div>
...
const WhyUs = () => {
  const { t } = useLanguage();
  const features = [
    { icon: Zap, title: t("land.feat.fast"), desc: t("land.feat.fastDesc") },
    { icon: Star, title: t("land.feat.real"), desc: t("land.feat.realDesc") },
    {
      icon: Crown,
      title: t("land.feat.top"),
      desc: t("land.feat.topDesc"),
    },
    { icon: Brain, title: t("land.feat.ai"), desc: t("land.feat.aiDesc") },
    {
      icon: Shield,
      title: t("land.feat.safe"),
      desc: t("land.feat.safeDesc"),
    },
    { icon: Users, title: t("land.feat.com"), desc: t("land.feat.comDesc") },
  ];
  return (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            ...
            >
              ...
              <p className="text-sm text-blue-600">{f.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
  ...
  const steps = [
    {
      n: "01",
      title: t("land.step1"),
      desc: t("land.step1Desc"),
    },
    {
      n: "02",
      title: t("land.step2"),
      desc: t("land.step2Desc"),
    },
    { n: "03", title: t("land.step3"), desc: t("land.step3Desc") },
  ];
  return (
        ...
        <div className="grid md:grid-cols-3 gap-6 relative">
          {steps.map((s, i) => (
            ...
            >
              ...
              <p className="text-sm text-blue-600">{s.desc}</p>
              {i < steps.length - 1 && (
                <ArrowRight
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 tracking-tight mb-4">
            {t("land.premTitle1")}{" "}
            <span style={{ color: GOLD }}>{t("land.premAccent")}</span>
          </h2>
          ...
          <div className="flex items-baseline justify-center gap-2 mb-6">
            ...
            <span className="text-blue-700">{t("land.premPerMonth")}</span>
          </div>
          ...
          >
            <Crown className="w-4 h-4" /> {t("land.premBtn")}
          </Link>
        </motion.div>
      </div>
    </section>
    ...
    <section id="join" className="py-32 px-6 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <motion.div {...fadeUp}>
          ...
          >
            {t("land.joinBtn")} <ArrowRight className="w-4 h-4" />
          </Link>
        </motion.div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <motion.div {...fadeUp}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 tracking-tight mb-5">
            ...
            <span style={{ color: GOLD }}>BarberTop</span>
          </h2>
          <p className="text-blue-700 mb-8">{t("land.mobileDesc")}</p>
          <div className="flex flex-wrap gap-3">
            {[t("land.appStore"), t("land.googlePlay")].map((s) => (
              <button
                key={s}
          ...
          >
            ...
            <div className="absolute bottom-6 inset-x-4 p-4 rounded-2xl backdrop-blur-xl bg-white/80 border border-blue-200">
              ...
              <div className="flex items-center justify-between text-xs">
                <span className="text-blue-700">{t("land.todayTime")}</span>
                <span
    ...
    <footer className="bg-white border-t border-blue-200 px-6 pt-16 pb-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          {[
            {
              title: t("land.footer.company"),
              items: [
                t("land.footer.about"),
                t("land.footer.careers"),
            ...
            },
            {
              ...
              items: [
                ...
                t("land.footer.premium"),
                t("land.footer.forBarbers"),
              ],
            },
            {
              title: t("land.footer.legal"),
              items: [
                t("land.footer.terms"),
                t("land.footer.privacy"),
                t("land.footer.security"),
              ],
            },
          ].map((c, i) => (
            <div key={i}>
