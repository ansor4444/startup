...
import { Globe, Loader2, ArrowLeft, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="flex items-center gap-2 mb-6 justify-center">
          <img src={logoImg} alt="BarberTop" className="w-9 h-9 rounded-md object-cover" />
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••"
                  className="w-full px-3 py-2 pr-10 text-sm border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring/20" required minLength={6} />
                <button
                  type="button"
